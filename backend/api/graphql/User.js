const { objectType, extendType, inputObjectType, nonNull, intArg } = require('nexus')
...
const User = objectType({
    ...
    definition(t) {
        ...
        t.string('name', { description: 'User\'s full name' })
...
const UserInput = inputObjectType({
    name: 'UserInputType',
    definition(t) {
        t.nonNull.string('name', { description: 'User\'s full name' })
